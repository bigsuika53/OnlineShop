...
import com.bigsuika.onlineshop.service.CustomUserDetailsService;
...
public class ProductControllerWithJwtTest {
    @Autowired
    ...
    public void setup() {
        ...
        // Generate JWT token
        authToken = "Bearer " + jwtTokenUtil.generateToken(userDetails.getUsername());
    }

    // ProductControllerGetWithJWT unit test
    @Test
    public void PCG_JWT_Test() throws Exception{
    ...
    // ProductControllerPageWithJWT unit test
    @Test
    public void page_JWT_Test() throws Exception{
    ...
    // ProductControllerGetByIdWithJWT unit test
    @Test
    public void PCGid_JWT_Test() throws Exception{
    ...
    // ProductControllerCreateWithJWT unit test
    @Test
    public void PCC_JWT_Test() throws Exception{
    ...
    // ProductControllerUpdateWithJWT unit test
    @Test
    public void PCU_JWT_Test() throws Exception{
        Product product = new Product(100L, "prodU", 999.99, 10);
    ...
    // ProductControllerDeleteWithJWT unit test
    @Test
    public void PCD_JWT_Test() throws Exception{
